...
extern interface ITypeResolutionService {
  ...
  @:overload(function(name:dotnet.system.reflection.AssemblyName) : dotnet.system.reflection.Assembly {})
  function GetAssembly(name:dotnet.system.reflection.AssemblyName, throwOnError:Bool) : dotnet.system.reflection.Assembly;
