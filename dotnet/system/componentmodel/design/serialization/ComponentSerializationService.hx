...
extern class ComponentSerializationService extends dotnet.system.Object {
  ...
  @:overload(function(store:SerializationStore) : dotnet.system.collections.ICollection {})
  public function Deserialize(store:SerializationStore, container:dotnet.system.componentmodel.IContainer) : dotnet.system.collections.ICollection;

  @:overload(function(store:SerializationStore, container:dotnet.system.componentmodel.IContainer) : Void {})
  ...
  public function DeserializeTo(store:SerializationStore, container:dotnet.system.componentmodel.IContainer, validateRecycledTypes:Bool, applyDefaults:Bool) : Void;
