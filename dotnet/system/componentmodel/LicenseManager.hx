...
extern class LicenseManager extends dotnet.system.Object {
  ...
  @:overload(function(type:cs.system.Type, creationContext:LicenseContext) : Dynamic {})
  public static function CreateWithContext(type:cs.system.Type, creationContext:LicenseContext, args:cs.NativeArray<dotnet.system.Object>) : Dynamic;
  ...
  public static function Validate(type:cs.system.Type, instance:Dynamic) : License;
}
