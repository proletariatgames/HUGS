...
extern class ObjectManager extends dotnet.system.Object {
  ...
  @:overload(function(arrayToBeFixed:dotnet.system.Int64, index:Int, objectRequired:dotnet.system.Int64) : Void {})
  public function RecordArrayElementFixup(arrayToBeFixed:dotnet.system.Int64, indices:cs.NativeArray<Int>, objectRequired:dotnet.system.Int64) : Void;
  ...
  @:overload(function(obj:Dynamic, objectID:dotnet.system.Int64) : Void {})
  ...
  public function RegisterObject(obj:Dynamic, objectID:dotnet.system.Int64, info:SerializationInfo, idOfContainingObj:dotnet.system.Int64, member:dotnet.system.reflection.MemberInfo, arrayIndex:cs.NativeArray<Int>) : Void;
}
