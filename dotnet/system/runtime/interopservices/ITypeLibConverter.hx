...
extern interface ITypeLibConverter {
  ...
  function ConvertTypeLibToAssembly(typeLib:Dynamic, asmFileName:String, flags:TypeLibImporterFlags, notifySink:ITypeLibImporterNotifySink, publicKey:cs.NativeArray<dotnet.system.Byte>, keyPair:dotnet.system.reflection.StrongNameKeyPair, asmNamespace:String, asmVersion:dotnet.system.Version) : dotnet.system.reflection.emit.AssemblyBuilder;

  function GetPrimaryInteropAssembly(g:dotnet.system.Guid, major:Int, minor:Int, lcid:Int, asmName:cs.Out<String>, asmCodeBase:cs.Out<String>) : Bool;
}
