...
@:native("System.Runtime.Remoting.Metadata.W3cXsd2001.SoapYearMonth") @:final
extern class SoapYearMonth extends dotnet.system.Object  implements ISoapXsd {
  public var Sign : Int;
  ...
  public static function Parse(value:String) : SoapYearMonth;
