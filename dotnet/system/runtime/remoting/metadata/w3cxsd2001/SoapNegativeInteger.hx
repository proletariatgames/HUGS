...
@:native("System.Runtime.Remoting.Metadata.W3cXsd2001.SoapNegativeInteger") @:final
extern class SoapNegativeInteger extends dotnet.system.Object  implements ISoapXsd {
  ...
  public static function Parse(value:String) : SoapNegativeInteger;
