...
extern class ApplicationActivator extends dotnet.system.Object {
  ...
  public function CreateInstance(activationContext:dotnet.system.ActivationContext, activationCustomData:cs.NativeArray<String>) : dotnet.system.runtime.remoting.ObjectHandle;
