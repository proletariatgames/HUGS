...
extern class XmlDocument extends XmlNode {
  ...
  @:overload(function(prefix:String, localName:String, namespaceURI:String) : XmlAttribute {})
  ...
  function CreateDefaultAttribute(prefix:String, localName:String, namespaceURI:String) : XmlAttribute;
  ...
  @:overload(function(prefix:String, localName:String, namespaceURI:String) : XmlElement {})
  ...
  @:overload(function(type:XmlNodeType, prefix:String, name:String, namespaceURI:String) : XmlNode {})
  @:overload(function(type:XmlNodeType, name:String, namespaceURI:String) : XmlNode {})
  public function CreateNode(nodeTypeString:String, name:String, namespaceURI:String) : XmlNode;
  ...
  @:overload(function(xmlWriter:XmlWriter) : Void {})
