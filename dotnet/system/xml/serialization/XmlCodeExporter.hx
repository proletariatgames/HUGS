...
extern class XmlCodeExporter extends CodeExporter {
  ...
  @:overload(function(metadata:dotnet.system.codedom.CodeAttributeDeclarationCollection, member:XmlMemberMapping, ns:String, forceUseMemberName:Bool) : Void {})
  @:overload(function(metadata:dotnet.system.codedom.CodeAttributeDeclarationCollection, member:XmlTypeMapping, ns:String) : Void {})
  public function AddMappingMetadata(metadata:dotnet.system.codedom.CodeAttributeDeclarationCollection, member:XmlMemberMapping, ns:String) : Void;
