...
extern class XmlSerializerFactory extends dotnet.system.Object {
  ...
  @:overload(function(type:cs.system.Type) : XmlSerializer {})
  ...
  public function CreateSerializer(type:cs.system.Type, overrides:XmlAttributeOverrides, extraTypes:cs.NativeArray<cs.system.Type>, root:XmlRootAttribute, defaultNamespace:String, location:String, evidence:dotnet.system.security.policy.Evidence) : XmlSerializer;
