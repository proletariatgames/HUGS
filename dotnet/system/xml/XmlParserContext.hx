...
extern class XmlParserContext extends dotnet.system.Object {
  ...
  @:overload(function(nt:XmlNameTable, nsMgr:XmlNamespaceManager, xmlLang:String, xmlSpace:XmlSpace) : Void {})
  ...
  public function new(nt:XmlNameTable, nsMgr:XmlNamespaceManager, docTypeName:String, pubId:String, sysId:String, internalSubset:String, baseURI:String, xmlLang:String, xmlSpace:XmlSpace, enc:dotnet.system.text.Encoding) : Void;
}
