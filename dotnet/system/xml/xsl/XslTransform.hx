...
extern class XslTransform extends dotnet.system.Object {
  ...
  public function Load(stylesheet:dotnet.system.xml.XmlReader, resolver:dotnet.system.xml.XmlResolver, evidence:dotnet.system.security.policy.Evidence) : Void;

  @:overload(function(input:dotnet.system.xml.xpath.IXPathNavigable, args:XsltArgumentList) : dotnet.system.xml.XmlReader {})
  ...
  public function Transform(inputfile:String, outputfile:String, resolver:dotnet.system.xml.XmlResolver) : Void;
}
