...
extern class Int64 extends ValueType  implements IComparable implements IConvertible implements IComparable1<Int64> implements IFormattable implements IEquatable<Int64> {
  ...
  @:overload(function(s:String, result:cs.Out<Int64>) : Bool {})
  public static function TryParse(s:String, style:dotnet.system.globalization.NumberStyles, provider:IFormatProvider, result:cs.Out<Int64>) : Bool;
}
