...
extern class Attribute extends Object  implements dotnet.system.runtime.interopservices._Attribute {
  ...
  @:overload(function(element:dotnet.system.reflection.Assembly, attributeType:cs.system.Type) : Attribute {})
  ...
  public static function GetCustomAttribute(element:dotnet.system.reflection.MemberInfo, attributeType:cs.system.Type, inherit:Bool) : Attribute;

  @:overload(function(element:dotnet.system.reflection.Assembly) : cs.NativeArray<Attribute> {})
  ...
  public static function GetCustomAttributes(element:dotnet.system.reflection.ParameterInfo, inherit:Bool) : cs.NativeArray<Attribute>;
  ...
  public static function IsDefined(element:dotnet.system.reflection.ParameterInfo, attributeType:cs.system.Type, inherit:Bool) : Bool;
