...
extern class Activator extends Object  implements dotnet.system.runtime.interopservices._Activator {
  ...
  @:overload(function(assemblyName:String, typeName:String, hashValue:cs.NativeArray<Byte>, hashAlgorithm:dotnet.system.configuration.assemblies.AssemblyHashAlgorithm) : dotnet.system.runtime.remoting.ObjectHandle {})
  ...
  @:overload(function(type:cs.system.Type, url:String, state:Dynamic) : Dynamic {})
