...
extern class Queryable extends dotnet.system.Object {
  ...
  @:overload(function(source:Dynamic, seed:Dynamic, func:dotnet.system.linq.expressions.Expression1<Dynamic>, selector:dotnet.system.linq.expressions.Expression1<Dynamic>) : Dynamic {})
  ...
  @:overload(function(source:Dynamic, predicate:dotnet.system.linq.expressions.Expression1<Dynamic>) : Bool {})
  public static function Any(source:Dynamic) : Bool;

  @:overload(function(source:dotnet.system.collections.IEnumerable) : IQueryable {})
  ...
  @:overload(function(source:Dynamic, selector:dotnet.system.linq.expressions.Expression1<Dynamic>) : dotnet.system.Nullable1<dotnet.system.Single> {})
  ...
  @:overload(function(source:IQueryable1<dotnet.system.Single>) : Float {})
  ...
  @:overload(function(source:IQueryable1<dotnet.system.Nullable1<dotnet.system.Single>>) : dotnet.system.Nullable1<dotnet.system.Single> {})
  ...
  public static function Average(source:IQueryable1<dotnet.system.Decimal>) : dotnet.system.Decimal;
  ...
  @:overload(function(source:Dynamic, item:Dynamic, comparer:Dynamic) : Bool {})
  public static function Contains(source:Dynamic, item:Dynamic) : Bool;

  @:overload(function(source:Dynamic, predicate:dotnet.system.linq.expressions.Expression1<Dynamic>) : Int {})
  public static function Count(source:Dynamic) : Int;

  @:overload(function(source:Dynamic, defaultValue:Dynamic) : Dynamic {})
  public static function DefaultIfEmpty(source:Dynamic) : Dynamic;

  @:overload(function(source:Dynamic, comparer:Dynamic) : Dynamic {})
  ...
  @:overload(function(source1:Dynamic, source2:dotnet.system.collections.IEnumerable, comparer:Dynamic) : Dynamic {})
  ...
  @:overload(function(source:Dynamic, keySelector:dotnet.system.linq.expressions.Expression1<Dynamic>, elementSelector:dotnet.system.linq.expressions.Expression1<Dynamic>, resultSelector:dotnet.system.linq.expressions.Expression1<Dynamic>, comparer:Dynamic) : Dynamic {})
  ...
  @:overload(function(source:Dynamic, predicate:dotnet.system.linq.expressions.Expression1<Dynamic>) : dotnet.system.Int64 {})
  ...
  @:overload(function(source:Dynamic, keySelector:dotnet.system.linq.expressions.Expression1<Dynamic>, comparer:dotnet.system.collections.IComparer) : Dynamic {})
  ...
  @:overload(function(source1:Dynamic, source2:dotnet.system.collections.IEnumerable, comparer:Dynamic) : Bool {})
  ...
  public static function Sum(source:IQueryable1<dotnet.system.Decimal>) : dotnet.system.Decimal;
