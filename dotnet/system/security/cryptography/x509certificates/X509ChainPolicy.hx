...
extern class X509ChainPolicy extends dotnet.system.Object {
  public var ApplicationPolicy(default,never) : dotnet.system.security.cryptography.OidCollection;
  public var CertificatePolicy(default,never) : dotnet.system.security.cryptography.OidCollection;
  public var ExtraStore(default,never) : X509Certificate2Collection;
