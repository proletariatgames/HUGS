...
extern class PasswordDeriveBytes extends DeriveBytes {
  ...
  @:overload(function(password:cs.NativeArray<dotnet.system.Byte>, salt:cs.NativeArray<dotnet.system.Byte>, hashName:String, iterations:Int, cspParams:CspParameters) : Void {})
