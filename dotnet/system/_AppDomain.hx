...
extern interface _AppDomain {
  ...
  function CreateInstance(assemblyName:String, typeName:String) : dotnet.system.runtime.remoting.ObjectHandle;
  ...
  function CreateInstanceFrom(assemblyFile:String, typeName:String) : dotnet.system.runtime.remoting.ObjectHandle;
  ...
  function DefineDynamicAssembly(name:dotnet.system.reflection.AssemblyName, access:dotnet.system.reflection.emit.AssemblyBuilderAccess) : dotnet.system.reflection.emit.AssemblyBuilder;
  ...
  function ExecuteAssembly(assemblyFile:String) : Int;
  ...
  function Load(assemblyRef:dotnet.system.reflection.AssemblyName) : dotnet.system.reflection.Assembly;
