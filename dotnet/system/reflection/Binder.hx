...
extern class Binder extends dotnet.system.Object {
  ...
  public function BindToMethod(bindingAttr:BindingFlags, match:cs.NativeArray<MethodBase>, args:Dynamic, modifiers:cs.NativeArray<ParameterModifier>, culture:dotnet.system.globalization.CultureInfo, names:cs.NativeArray<String>, state:Dynamic) : MethodBase;

  public function ChangeType(value:Dynamic, type:cs.system.Type, culture:dotnet.system.globalization.CultureInfo) : Dynamic;

  public function ReorderArgumentArray(args:Dynamic, state:Dynamic) : Void;
