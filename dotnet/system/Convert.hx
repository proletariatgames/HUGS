...
extern class Convert_Static {
  ...
  @:overload(function(inArray:cs.NativeArray<Byte>, offsetIn:Int, length:Int, outArray:cs.NativeArray<Char>, offsetOut:Int, options:Base64FormattingOptions) : Int {})
  ...
  @:overload(function(inArray:cs.NativeArray<Byte>, offset:Int, length:Int, options:Base64FormattingOptions) : String {})
  ...
  @:overload(function(value:Dynamic, provider:IFormatProvider) : Char {})
  ...
  @:overload(function(value:UInt64) : DateTime {})
  ...
  public static function ToDateTime(value:Bool) : DateTime;
  ...
  @:overload(function(value:Dynamic, provider:IFormatProvider) : Int64 {})
  ...
  @:overload(function(value:Dynamic, provider:IFormatProvider) : UInt64 {})
