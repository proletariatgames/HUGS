...
extern class Ping extends dotnet.system.componentmodel.Component  implements dotnet.system.IDisposable {
  ...
  @:overload(function(address:dotnet.system.net.IPAddress) : PingReply {})
  ...
  public function Send(address:dotnet.system.net.IPAddress, timeout:Int, buffer:cs.NativeArray<dotnet.system.Byte>, options:PingOptions) : PingReply;
  ...
  public function SendAsync(address:dotnet.system.net.IPAddress, timeout:Int, buffer:cs.NativeArray<dotnet.system.Byte>, options:PingOptions, userToken:Dynamic) : Void;
