...
extern class AlternateView extends AttachmentBase {
  ...
  @:overload(function(content:String) : AlternateView {})
  @:overload(function(content:String, contentType:dotnet.system.net.mime.ContentType) : AlternateView {})
  public static function CreateAlternateViewFromString(content:String, encoding:dotnet.system.text.Encoding, mediaType:String) : AlternateView;
  ...
  public function new(contentStream:dotnet.system.io.Stream, contentType:dotnet.system.net.mime.ContentType) : Void;
}
