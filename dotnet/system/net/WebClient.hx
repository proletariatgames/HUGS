...
extern class WebClient extends dotnet.system.componentmodel.Component {
  ...
  public function DownloadDataAsync(address:dotnet.system.Uri, userToken:Dynamic) : Void;
  ...
  public function DownloadFileAsync(address:dotnet.system.Uri, fileName:String, userToken:Dynamic) : Void;

  @:overload(function(address:String) : String {})
  public function DownloadString(address:dotnet.system.Uri) : String;

  @:overload(function(address:dotnet.system.Uri) : Void {})
  public function DownloadStringAsync(address:dotnet.system.Uri, userToken:Dynamic) : Void;
  ...
  @:overload(function(address:dotnet.system.Uri) : Void {})
  public function OpenReadAsync(address:dotnet.system.Uri, userToken:Dynamic) : Void;
  ...
  public function OpenWrite(address:dotnet.system.Uri, method:String) : dotnet.system.io.Stream;

  @:overload(function(address:dotnet.system.Uri) : Void {})
  @:overload(function(address:dotnet.system.Uri, method:String) : Void {})
  public function OpenWriteAsync(address:dotnet.system.Uri, method:String, userToken:Dynamic) : Void;
  ...
  public function UploadData(address:dotnet.system.Uri, method:String, data:cs.NativeArray<dotnet.system.Byte>) : cs.NativeArray<dotnet.system.Byte>;
  ...
  public function UploadDataAsync(address:dotnet.system.Uri, method:String, data:cs.NativeArray<dotnet.system.Byte>, userToken:Dynamic) : Void;
  ...
  public function UploadFile(address:dotnet.system.Uri, method:String, fileName:String) : cs.NativeArray<dotnet.system.Byte>;

  @:overload(function(address:dotnet.system.Uri, fileName:String) : Void {})
  @:overload(function(address:dotnet.system.Uri, method:String, fileName:String) : Void {})
  public function UploadFileAsync(address:dotnet.system.Uri, method:String, fileName:String, userToken:Dynamic) : Void;
  ...
  public function UploadString(address:dotnet.system.Uri, method:String, data:String) : String;

  @:overload(function(address:dotnet.system.Uri, data:String) : Void {})
  @:overload(function(address:dotnet.system.Uri, method:String, data:String) : Void {})
  public function UploadStringAsync(address:dotnet.system.Uri, method:String, data:String, userToken:Dynamic) : Void;
  ...
  public function UploadValues(address:dotnet.system.Uri, method:String, data:dotnet.system.collections.specialized.NameValueCollection) : cs.NativeArray<dotnet.system.Byte>;

  @:overload(function(address:dotnet.system.Uri, values:dotnet.system.collections.specialized.NameValueCollection) : Void {})
  ...
  public function UploadValuesAsync(address:dotnet.system.Uri, method:String, values:dotnet.system.collections.specialized.NameValueCollection, userToken:Dynamic) : Void;
}
