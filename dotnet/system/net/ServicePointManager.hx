...
extern class ServicePointManager extends dotnet.system.Object {
  ...
  @:overload(function(address:dotnet.system.Uri) : ServicePoint {})
  @:overload(function(uriString:String, proxy:IWebProxy) : ServicePoint {})
  public static function FindServicePoint(address:dotnet.system.Uri, proxy:IWebProxy) : ServicePoint;
}
