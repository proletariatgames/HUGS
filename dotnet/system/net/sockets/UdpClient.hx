...
extern class UdpClient extends dotnet.system.Object  implements dotnet.system.IDisposable {
  ...
  public function BeginSend(datagram:cs.NativeArray<dotnet.system.Byte>, bytes:Int, hostname:String, port:Int, requestCallback:dotnet.system.AsyncCallback, state:Dynamic) : dotnet.system.IAsyncResult;
  ...
  public function Send(dgram:cs.NativeArray<dotnet.system.Byte>, bytes:Int, hostname:String, port:Int) : Int;
}
