...
extern class Collection<T> extends dotnet.system.Object  implements dotnet.system.collections.generic.ICollection<T> implements dotnet.system.collections.generic.IList<T> implements dotnet.system.collections.generic.IEnumerable<T> implements dotnet.system.collections.ICollection implements dotnet.system.collections.IEnumerable implements dotnet.system.collections.IList {
