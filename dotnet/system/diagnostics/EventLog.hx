...
extern class EventLog_Static {
  ...
  @:overload(function(source:String, machineName:String) : Void {})
  public static function DeleteEventSource(source:String) : Void;

  @:overload(function(logName:String, machineName:String) : Bool {})
  public static function Exists(logName:String) : Bool;

  @:overload(function(machineName:String) : cs.NativeArray<EventLog> {})
  ...
  @:overload(function(source:String, machineName:String) : Bool {})
  public static function SourceExists(source:String) : Bool;

  @:overload(function(source:String, message:String, type:EventLogEntryType, eventID:Int, category:Int, rawData:cs.NativeArray<dotnet.system.Byte>) : Void {})
  ...
  @:overload(function(source:String, instance:EventInstance, data:cs.NativeArray<dotnet.system.Byte>, values:cs.NativeArray<dotnet.system.Object>) : Void {})
