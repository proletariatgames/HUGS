...
extern class Debug extends dotnet.system.Object {
  ...
  @:overload(function(start:Vector3, end:Vector3, color:Color, duration:Single, depthTest:Bool) : Void {})
  @:overload(function(start:Vector3, end:Vector3, color:Color, duration:Single) : Void {})
  ...
  @:overload(function(start:Vector3, dir:Vector3, color:Color, duration:Single) : Void {})
  @:overload(function(start:Vector3, dir:Vector3, color:Color) : Void {})
  @:overload(function(start:Vector3, dir:Vector3) : Void {})
  public static function DrawRay(start:Vector3, dir:Vector3, color:Color, duration:Single, depthTest:Bool) : Void;
