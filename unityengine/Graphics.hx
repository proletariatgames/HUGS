...
extern class Graphics extends dotnet.system.Object {
  ...
  @:overload(function(source:Texture, dest:RenderTexture) : Void {})
  ...
  public static function Blit(source:Texture, mat:Material, pass:Int) : Void;
  ...
  @:overload(function(mesh:Mesh, matrix:Matrix4x4) : Void {})
  ...
  public static function DrawTexture(screenRect:Rect, texture:Texture, sourceRect:Rect, leftBorder:Int, rightBorder:Int, topBorder:Int, bottomBorder:Int, color:Color, mat:Material) : Void;
