...
extern class RenderTexture extends Texture {
  ...
  @:overload(function(width:Int, height:Int, depth:Int, format:RenderTextureFormat,
                      readWrite:RenderTextureReadWrite) : Void {})
  ...
  public static function GetTemporary(width:Int, height:Int, depthBuffer:Int,
                                      format:RenderTextureFormat,
                                      readWrite:RenderTextureReadWrite) : RenderTexture;
